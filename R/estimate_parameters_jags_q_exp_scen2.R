...
load("R/prop_survey_scen2.RData")
...
save(list=c("fit_GBV_25_exp", "fit_GBV_26_exp", "fit_GBV_27_exp", "fit_GBV_31_exp", "fit_GBV_34_exp", "fit_GBV_35_exp"),
     file="R/parameters_exp_scen2.RData")
