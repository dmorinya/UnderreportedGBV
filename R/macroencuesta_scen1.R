...
dades$Visita <- ifelse(dades$M1P8==2 | dades$M1P8==4 | 
                       dades$M2P8==2 | dades$M2P8==4 |
                       dades$M3P2K==2 | dades$M3P2K==4, 1, 0)

p2 <- table(dades$Visita)[2]/table(dades$VIOLENCIA)[2]
...
save(list=c("prop_survey"), file="R/prop_survey_scen1.RData")